...
# Function to upload and process video for detection
def process_video(video_path):
    # Video capture from uploaded video file
...
video_path = r"C:\Users\Admin\Downloads\Fireandsmoke combined\fire4.mp4"
